...
**Output:**
- Intent sealed class (`{Feature}Intent.kt`) - MUST extend `MviIntent`
- UiState data class (`{Feature}UiState.kt`) - MUST extend `MviUiState`
- UiEffect sealed class (`{Feature}UiEffect.kt`) - MUST extend `MviUiEffect`
- ViewModel (`{Feature}ViewModel.kt`) - MUST extend `MviViewModel<Intent, UiState, UiEffect>`

**Rules:**
- Intent MUST extend `MviIntent` interface
- UiState MUST extend `MviUiState` interface
- UiEffect MUST extend `MviUiEffect` interface
